...
public class AustAdapter extends BaseAdapter {
    Context mContext = null;
    LayoutInflater mLayoutInflater = null;
    ArrayList<AuStData> sample;

    public AustAdapter(Context context, ArrayList<AuStData> data) {
        mContext = context;
        sample = data;
    ...
    public View getView(int position, View converView, ViewGroup parent) {
        View view = mLayoutInflater.inflate(R.layout.austdesign, null);
